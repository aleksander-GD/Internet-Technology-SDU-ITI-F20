...
VALUES
	...
	(
		...
		'William Simonsen',
		'willien@gmail.com',
		'$2y$12$c.hm0gn.iSYgfTcLiBxEQu8f/8wpDRadGbkGqhzUxWQf3mHem3rI2'
	),
	(
		'bjarkech',
		'Bjarke Ellegaard-Hald Bech',
		'bjarkech@gmail.com',
		'$2y$12$c.hm0gn.iSYgfTcLiBxEQu8f/8wpDRadGbkGqhzUxWQf3mHem3rI2'
	);
	...
	(
		(
			...
			FROM
				user
			WHERE
				user.username = 'willien'
		),
		'images/cwwBXiMibTY.jpg',
		'Motorcycle',
		'Ride in the dessert'
	),
	(
		(
			...
			FROM
				user
			WHERE
				user.username = 'bjarkech'
		),
		'images/mxdDX98iMKo.jpg',
		'German Shepherd',
		'Picture of my dog while on vacation'
	);